...
namespace Common
{
    public class ConfigurationManager
    {
        ...
        private Dictionary<string, IList<string>> ReverseHierarchy(
            Dictionary<string, IList<string>> configurationsHierarchy)
        {
        ...
        {
            return (ProcessedDeps.Contains(config) || (config != null && configHierarchy.ContainsKey(config) &&
                                                       configHierarchy[config].Any(ProcessedParentDfs)));
        }
    }
}
