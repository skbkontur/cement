...
namespace Tests.ParsersTests
{
    ...
    class TestRulesetFile
    {
        ...
        {
            var expectedXml =
                $"<?xml version=\"1.0\" encoding=\"utf-8\"?><RuleSet Name=\"{Guid.NewGuid()}\" Description=\"{Guid.NewGuid()}\" ToolsVersion=\"10.0\"></RuleSet>";
        ...
        public void Include_AddRulesetPathAsIs_IfRulesetPathIsRelative()
        {
            ...
            Console.WriteLine(rulesetFile.Document.OuterXml);
            Assert.IsNotNull(SearchByXpath(rulesetFile.Document, $"a:RuleSet/a:Include[@Path = '{rulesetPath}']")
                .Single());
        }
        ...
        public void Include_AddRulesetPathAsIs_IfRulesetPathIsMicrosoftRules()
        {
            ...
            Console.WriteLine(rulesetFile.Document.OuterXml);
            Assert.IsNotNull(SearchByXpath(rulesetFile.Document, $"a:RuleSet/a:Include[@Path = '{microsoftRules}']")
                .Single());
        }
        ...
        public void Include_AddRulesetPathAsRelative_IfRulesetPathIsAbsolute()
        {
            ...
            Console.WriteLine(rulesetFile.Document.OuterXml);
            Assert.IsNotNull(SearchByXpath(rulesetFile.Document,
                $"a:RuleSet/a:Include[@Path = '{expectedRelRulesetPath}']").Single());
        }
