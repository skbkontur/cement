        ...
        private static TestCaseData[] ArtifactsSource =
        {
            new TestCaseData(null, new[] { "a1", "a2" }, new[] { "a3", "a4" },
                    new InstallData
                    {
                        ...
                        MainConfigBuildFiles = { "a1", "a2", "a3", "a4" }
                    })
            ...
            new TestCaseData(new[] { "a1" }, new[] { "a2" }, new[] { "a3" },
                    new InstallData
                    {
                        BuildFiles = { "a1" },
                        Artifacts = { "a1", "a2", "a3" },
                        MainConfigBuildFiles = { "a1", "a2", "a3" }
                    })
                .SetName("Install section: artifacts. Build files from install section are added to artifacts"),
        ...
        private static TestCaseData[] BuildFilesSource =
        {
            new TestCaseData(
                    ...
                    new InstallData
                    {
                        ...
                        MainConfigBuildFiles = { "file1", "file2", "file3" },
                        ExternalModules = { "Module1" },
                        NuGetPackages = { "Nuget1" }
                    })
