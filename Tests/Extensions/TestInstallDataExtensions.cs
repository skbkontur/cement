...
namespace Tests.Extensions
{
    ...
    public class TestInstallDataExtensions
    {
        ...
        {
            var actual = First.JoinWith(Second);
        ...
        {
            var actual = First.JoinWith(Second).Artifacts;
        ...
        {
            var actual = First.JoinWith(Second).InstallFiles;
            var expected = new List<string> {"first_i1", "first_i2", "common_i", "second_i1", "second_i2"};
            actual.Should().BeEquivalentTo(expected, o => o.WithStrictOrdering());
        }

        [Test]
        public void JoinWithCreatesValidCurrentConfigurationInstallFilesList()
        {
            var actual = First.JoinWith(Second).CurrentConfigurationInstallFiles;
            var expected = new List<string> {"first_i1", "first_i2", "common_i", "first_a1", "first_a2", "common_a", "second_i1", "second_i2", "second_a1", "second_a2"};
            actual.Should().BeEquivalentTo(expected, o => o.WithStrictOrdering());
        }
        ...
        {
            var actual = First.JoinWith(Second).ExternalModules;
        ...
        {
            var actual = First.JoinWith(Second).NuGetPackages;
