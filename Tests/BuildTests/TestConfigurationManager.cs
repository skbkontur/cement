...
namespace Tests.BuildTests
{
    ...
    public class TestConfigurationManager
    {
        ...
        public void TestProcessedChildrens()
        {
            ...
            Assert.False(manager.ProcessedChildrenConfigurations(new Dep("module", null, "full-build"))
                .Contains("client"));
            Assert.True(manager.ProcessedChildrenConfigurations(new Dep("module", null, "full-build"))
                .Contains("subclient"));
        }
    }
    ...
    public class TestTreeishManager
    {
        ...
        {
            Assert.DoesNotThrow(() => TreeishManager.ThrowOnTreeishConflict(
